...
import { getRequest, deleteRequest } from "@/utils/apiUtils";
        ...
        <div className="mx-4 mb-4">
            <div className="flex my-4 justify-between">
                ...
                <Button
                    ...
                    onClick={() => router.push("/add-form-template")}
                >
                                    ...
                                    <TableCell className="text-right">
                                        <div className="flex gap-2 justify-end">
                                            <Button
                                                ...
                                                className="cursor-pointer"
                                                aria-label="Edit"
                                                onClick={() => router.push(`/add-form-template?edit=${item.id}`)} // Use query param instead of state
                                            >
