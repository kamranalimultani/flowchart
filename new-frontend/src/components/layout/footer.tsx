...
import Link from "next/link"; // Changed from 'a' tags where appropriate
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <p className="text-muted-foreground mb-6 max-w-sm">
                            ...
                            analytics, AI insights, and enterprise-grade features.
                        </p>
                        <div className="flex gap-4">
                            {/* LinkedIn */}
                            <a
                                href="https://www.linkedin.com/in/kg-ali-76a5ba389"
                                target="_blank"
                            ...
                            {/* Instagram */}
                            <a
                                href="https://www.instagram.com/melvok.official?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-10 h-10 rounded-lg bg-muted hover:bg-primary hover:text-primary-foreground flex items-center justify-center transition-all duration-300 hover:scale-110"
                            >
                            ...
                            {/* Reddit */}
                            <a
                                href="https://www.reddit.com/user/melvok_official/?utm_source=share&utm_medium=web3x&utm_name=web3xcss&utm_term=1&utm_content=share_button"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-10 h-10 rounded-lg bg-muted hover:bg-primary hover:text-primary-foreground flex items-center justify-center transition-all duration-300 hover:scale-110"
                            >
