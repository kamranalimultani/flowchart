...
function DemoVideo() {
  ...
  return (
    <>
      <Helmet>
        <title>Melvok Product Demo | Watch Overview Video</title>
        <meta
          name="description"
          content="Watch the Melvok demo video and learn how to create, manage, and automate survey workflows with ease."
        />
        <link rel="canonical" href="https://melvok.com/demo-video" />
      </Helmet>
