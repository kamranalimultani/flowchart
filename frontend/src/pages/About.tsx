...
export default function AboutPage() {
  ...
  return (
    <>
      {/* 🧠 SEO / Meta Tags */}
      <Helmet>
        <title>About Melvok | Visual Flow-Based Survey Platform</title>

        <meta
          name="description"
          content="Learn more about Melvok — a modern flow survey platform empowering creators and enterprises to collect feedback, analyze data, and act on insights with simplicity and confidence."
        />

        <meta
          name="keywords"
          content="About Melvok, flow survey platform, visual form builder, feedback analytics, interactive surveys, data insights, business intelligence, survey software"
        />

        {/* Canonical */}
        <link rel="canonical" href="https://melvok.com/about" />

        {/* Open Graph / Facebook */}
        <meta
          property="og:title"
          content="About Melvok | Visual Flow-Based Survey Platform"
        />
        <meta
          property="og:description"
          content="Discover Melvok's mission to turn questions into insights with an interactive, visual survey builder for modern teams and enterprises."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://melvok.com/about" />
        <meta property="og:image" content="https://melvok.com/og-image.png" />
        ...
        <meta
          ...
          content="Explore Melvok — the platform that makes feedback visual, actionable, and insightful."
        />
        <meta
          name="twitter:image"
          content="https://melvok.com/twitter-image.png"
        />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "AboutPage",
            url: "https://melvok.com/about",
            name: "About Melvok",
            description:
              "Melvok is a modern visual survey and analytics platform that turns questions into insights for teams and enterprises.",
            publisher: {
              "@type": "Organization",
              name: "Melvok",
